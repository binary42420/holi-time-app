...
export const apiService = {
  ...
  assignWorker: (shiftId: string, userId: string, roleCode: string, ignoreConflicts = false) => fetchFromApi<void>(`/shifts/${shiftId}/assign-worker`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ userId, roleCode, ignoreConflicts }) }),
